...
spmd.info.create <- function(info = .mpiopt_get("SPMD.CT", "info")){
...
spmd.info.set <- function(info = .mpiopt_get("SPMD.CT", "info"), key, value){
...
spmd.info.free <- function(info = .mpiopt_get("SPMD.CT", "info")){
...
spmd.info.c2f <- function(info = .mpiopt_get("SPMD.CT", "info")){
