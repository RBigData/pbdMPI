...
spmd.info.create <- function(info = .pbdEnv$SPMD.CT$info){
...
spmd.info.set <- function(info = .pbdEnv$SPMD.CT$info, key, value){
...
spmd.info.free <- function(info = .pbdEnv$SPMD.CT$info){
...
spmd.info.c2f <- function(info = .pbdEnv$SPMD.CT$info){
