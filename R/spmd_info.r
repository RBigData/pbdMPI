...
spmd.info.create <- function(info = .pbdMPIEnv$SPMD.CT$info){
...
spmd.info.set <- function(info = .pbdMPIEnv$SPMD.CT$info, key, value){
...
spmd.info.free <- function(info = .pbdMPIEnv$SPMD.CT$info){
...
spmd.info.c2f <- function(info = .pbdMPIEnv$SPMD.CT$info){
