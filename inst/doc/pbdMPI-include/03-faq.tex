...
\end{Error}
      ...
      system of login node does not have a MPI system, or MPI system is
      only allowed to be loaded in computing node. The solution is to use extra
      flag to \code{R CMD INSTALL --no-test-load pbdMPI*.tar.gz}.
