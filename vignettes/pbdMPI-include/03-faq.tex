...
\item {\bf\color{blue} Q:}
      Does \pkg{pbdMPI} support 64 bits integer? \\
      {\bf\color{blue} A:}
      The answer is dependent on your MPI libraries even you have 64 bits
      integer in \proglang{R} which does not mean you can use 64 bits integer
      in \pkg{pbdMPI}. You may need to recompile MPI libraries for 64 bits
