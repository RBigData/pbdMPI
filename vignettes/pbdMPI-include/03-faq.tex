...
\item {\bf\color{blue} Q:}
      ...
      at \url{https://echo.rendering.prod.mscas.io/en-us/download/}.
...
\item {\bf\color{blue} Q:}
      ...
      website for details at \url{https://pbdr.org/}.
...
\item {\bf\color{blue} Q:}
      ...
      {\bf\color{blue} A:}
      See \url{https://snoweye.github.io/pbdr/aws_ec2.html}
      for setting a cluster on AWS EC2.

\item {\bf\color{blue} Q:}
      Does \pkg{pbdMPI} support multiple nodes in VirtualBox? \\
      {\bf\color{blue} A:}
      See \url{https://snoweye.github.io/pbdr/multiple_nodes.html}
