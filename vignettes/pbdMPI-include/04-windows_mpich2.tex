...
\section[Windows Systems (MPICH2)]{Windows Systems (MPICH2)}
\label{sec:windows_systems_mpich2}
\addcontentsline{toc}{section}{\thesection. Windows Systems (MPICH2)}

{\color{red} \bf Warning:}
MPICH2 is no longer maintained. Please consider use MS-MPI instead
for windows system, Section~\ref{sec:windows_systems_msmpi}.
This section is only for reference and other extension purposes.
