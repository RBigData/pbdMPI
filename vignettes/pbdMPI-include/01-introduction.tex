...
(\url{https://en.wikipedia.org/wiki/Message_Passing_Interface}). The
package is mainly developed and tested under {\color{blue} OpenMPI}
(\url{https://www.open-mpi.org/}) in xubuntu 11.04
(\url{https://xubuntu.org/}). The package should also work with
% LAM/MPI (\url{https://www.lam-mpi.org/}),
MPICH2 (\url{https://www.mpich.org/}) and
Microsoft MPI or MS-MPI
(\url{https://learn.microsoft.com/en-us/message-passing-interface/microsoft-mpi?redirectedfrom=MSDN}).
