...
SEXP spmd_alltoallv_integer(SEXP R_send_data, SEXP R_recv_data,
		...
		SEXP R_comm){
	spmd_errhandler(
		MPI_Alltoallv(INTEGER(R_send_data), LENGTH(R_send_data),
...
SEXP spmd_alltoallv_double(SEXP R_send_data, SEXP R_recv_data,
		...
		SEXP R_comm){
	spmd_errhandler(
		MPI_Alltoallv(REAL(R_send_data), LENGTH(R_send_data),
...
SEXP spmd_alltoallv_raw(SEXP R_send_data, SEXP R_recv_data,
		SEXP R_recv_counts, SEXP R_sdispls, SEXP R_rdispls,
		SEXP R_comm){
	spmd_errhandler(MPI_Alltoallv(RAW(R_send_data), LENGTH(R_send_data),
