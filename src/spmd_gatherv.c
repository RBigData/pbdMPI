...
SEXP spmd_gatherv_integer(SEXP R_send_data, SEXP R_recv_data,
		...
		SEXP R_comm){
	spmd_errhandler(MPI_Gatherv(INTEGER(R_send_data), XLENGTH(R_send_data),
...
SEXP spmd_gatherv_double(SEXP R_send_data, SEXP R_recv_data,
		SEXP R_recv_counts, SEXP R_displs, SEXP R_rank_dest,
		SEXP R_comm){
	spmd_errhandler(MPI_Gatherv(REAL(R_send_data), XLENGTH(R_send_data),
...
SEXP spmd_gatherv_raw(SEXP R_send_data, SEXP R_recv_data,
		SEXP R_recv_counts, SEXP R_displs, SEXP R_rank_dest,
		SEXP R_comm){
	spmd_errhandler(MPI_Gatherv(RAW(R_send_data), XLENGTH(R_send_data),
