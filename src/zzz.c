...
SEXP api_R_isort(SEXP R_x, SEXP R_comm, SEXP R_status, SEXP R_decreasing, SEXP R_nalast);
SEXP api_R_rsort(SEXP R_x, SEXP R_comm, SEXP R_status, SEXP R_decreasing, SEXP R_nalast);
...
static const R_CallMethodDef callMethods[] = 
{
  ...
  {"arrange_MPI_APTS", (DL_FUNC) &arrange_MPI_APTS, 1},
  ...
  {"spmd_sendrecv_replace_integer", (DL_FUNC) &spmd_sendrecv_replace_integer, 7},
  {"spmd_sendrecv_replace_double", (DL_FUNC) &spmd_sendrecv_replace_double, 7},
  {"spmd_sendrecv_replace_raw", (DL_FUNC) &spmd_sendrecv_replace_raw, 7},
